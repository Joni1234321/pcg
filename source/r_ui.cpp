...
pce::ui::ListElement::Handle pce::ui::UISystem::CreateList(const SDL_Color color, const SDL_FRect rect, const u32 count, const f32 gap, const ListDirection direction) {
...
void pce::ui::UISystem::IncreaseTableSize(TableElement& table_element, const Table& table) {
...
pce::ui::TableElement::Handle pce::ui::UISystem::CreateTable(const Table& table, SDL_Color text_color, const f32 x, const f32 y) {
...
void pce::ui::UISystem::UpdateTable(const TableElement::Handle& handle, const Table& table) {
