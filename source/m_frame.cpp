...
FPSFrame::FPSFrame(ui::UISystem& ui_system, const ui::FontCollection& font) : tick_text { ui_system.CreateText("", font.small, colors::blue, 10.0F, 0.0F) } { }
...
MainMenuFrame::MainMenuFrame(ui::UISystem& ui_system, const ui::FontCollection& font) {
    (void)ui_system.CreateText("Hey Helene!", font.h1, colors::light_sky_blue, 30.0F, 30.0F);
