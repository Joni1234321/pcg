...
FPSFrame::FPSFrame(ui::UISystem& ui_system) : tick_text { ui_system.CreateText("", ui_system.font.small, colors::blue, 10.0F, 0.0F, ui::TextAlign::center, 0U) } { }
...
MainMenuFrame::MainMenuFrame(ui::UISystem& ui_system) {
    (void)ui_system.CreateText("Hey Helene!", ui_system.font.h1, colors::light_sky_blue, 30.0F, 30.0F, ui::TextAlign::left, 0U);
...
OverviewFrame::OverviewFrame(ui::UISystem &ui_system) {
    ...
    table_handle = ui_system.CreateTable(table, ui_system.font, colors::light_sky_blue, table_x, table_y);
}
