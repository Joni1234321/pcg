...
Handle<UnitFormation> HexStateSpawnFormation(HexState& hex_state, CountryTag tag, Echelon echelon, const String& name) {
    UnitFormation formation { .tag = tag, .echelon = echelon };
...
void HexScenarioAi(HexState& hex_state) {
    ...
    const Handle<UnitFormation> ger_hgr = HexStateSpawnFormation(hex_state, CountryTag::TAG_GER, Echelon::ECHELON_ARMY, "6AOK");
    (void)HexStateSpawnUnit(hex_state, UnitSpawnCmd { .formation = ger_hgr, .icon = UnitIcon::ICON_HQ, .echelon = Echelon::ECHELON_ARMY }, { 1, 2 });

    const Handle<UnitFormation> ger_kps = HexStateSpawnFormation(hex_state, CountryTag::TAG_GER, Echelon::ECHELON_CORPS, "16AK");
    ...
    const Handle<UnitFormation> sov_frt = HexStateSpawnFormation(hex_state, CountryTag::TAG_SOV, Echelon::ECHELON_ARMY, "2GA");
    ...
    const Handle<UnitFormation> sov_kps = HexStateSpawnFormation(hex_state, CountryTag::TAG_SOV, Echelon::ECHELON_CORPS, "1TK");
    ...
    const Handle<UnitFormation> usa_hgr = HexStateSpawnFormation(hex_state, CountryTag::TAG_USA, Echelon::ECHELON_ARMY, "12AG");
    (void)HexStateSpawnUnit(hex_state, UnitSpawnCmd { .formation = usa_hgr, .icon = UnitIcon::ICON_HQ, .echelon = Echelon::ECHELON_ARMY }, { 17, 1 });

    const Handle<UnitFormation> usa_kps = HexStateSpawnFormation(hex_state, CountryTag::TAG_USA, Echelon::ECHELON_CORPS, "5CORPS");
...
void HexScenarioDivisionClash(HexState& hex_state) {
    ...
    const Handle<UnitFormation> ger_div1 = HexStateSpawnFormation(hex_state, CountryTag::TAG_GER, Echelon::ECHELON_DIVISION, "336ID");
    ...
    const Handle<UnitFormation> ger_div2 = HexStateSpawnFormation(hex_state, CountryTag::TAG_GER, Echelon::ECHELON_DIVISION, "11PZ");
    ...
    const Handle<UnitFormation> sov_div1 = HexStateSpawnFormation(hex_state, CountryTag::TAG_SOV, Echelon::ECHELON_DIVISION, "119RD");
    ...
    const Handle<UnitFormation> sov_div2 = HexStateSpawnFormation(hex_state, CountryTag::TAG_SOV, Echelon::ECHELON_DIVISION, "333RD");
