...
Handle<UnitFormation> HexStateSpawnFormation(HexState& hex_state, CountryTag tag, Echelon echelon) { return hex_state.unit_formations.EmplaceBack(UnitFormation { .tag = tag, .echelon = echelon }); }
...
void HexScenarioAi(HexState& hex_state) {
    ...
    const Handle<UnitFormation> ger_hgr = HexStateSpawnFormation(hex_state, CountryTag::TAG_GER, Echelon::ECHELON_ARMY);
    (void)HexStateSpawnUnit(hex_state, UnitSpawnCmd { .formation = ger_hgr, .icon = UnitIcon::ICON_HQ, .echelon = Echelon::ECHELON_ARMY }, { 1, 2 });

    const Handle<UnitFormation> ger_kps = HexStateSpawnFormation(hex_state, CountryTag::TAG_GER, Echelon::ECHELON_CORPS);
    ...
    const Handle<UnitFormation> sov_frt = HexStateSpawnFormation(hex_state, CountryTag::TAG_SOV, Echelon::ECHELON_ARMY);
    ...
    const Handle<UnitFormation> sov_kps = HexStateSpawnFormation(hex_state, CountryTag::TAG_SOV, Echelon::ECHELON_CORPS);
    ...
    const Handle<UnitFormation> usa_hgr = HexStateSpawnFormation(hex_state, CountryTag::TAG_USA, Echelon::ECHELON_ARMY);
    (void)HexStateSpawnUnit(hex_state, UnitSpawnCmd { .formation = usa_hgr, .icon = UnitIcon::ICON_HQ, .echelon = Echelon::ECHELON_ARMY }, { 17, 1 });

    const Handle<UnitFormation> usa_kps = HexStateSpawnFormation(hex_state, CountryTag::TAG_USA, Echelon::ECHELON_CORPS);
...
void HexScenarioDivisionClash(HexState& hex_state) {
    ...
    const Handle<UnitFormation> ger_div1 = HexStateSpawnFormation(hex_state, CountryTag::TAG_GER, Echelon::ECHELON_DIVISION);
    ...
    const Handle<UnitFormation> ger_div2 = HexStateSpawnFormation(hex_state, CountryTag::TAG_GER, Echelon::ECHELON_DIVISION);
    ...
    const Handle<UnitFormation> sov_div1 = HexStateSpawnFormation(hex_state, CountryTag::TAG_SOV, Echelon::ECHELON_DIVISION);
    ...
    const Handle<UnitFormation> sov_div2 = HexStateSpawnFormation(hex_state, CountryTag::TAG_SOV, Echelon::ECHELON_DIVISION);
